...
\frametitle{Discussion on GLM + GLM short intro}
	% \input{figs/tikz/glm_timeline.tikz}
	% o'hara, Warton, discussionon GLM vs LM
	% but also for ecotoxicological experiments?
\end{frame}
...
\frametitle{Risks: Compounds exceeding risk thresholds}
	...
	\end{itemize}
	\includegraphics[width = 0.75\textwidth]{figs/compounds.pdf}
\end{frame}
...
\\
\only<2->{
\vspace*{-1cm}\emph{''\alert{\textbf{webchem}} ...likely saved hundreds of working hours''} \\[5mm]
